...
// PicoModal 3.0.0 https://github.com/Nycto/PicoModal
// Copyright (c) 2012 James Frasca
// MIT license https://github.com/Nycto/PicoModal/blob/master/LICENSE.md
!function(a,b){"use strict";"function"==typeof define&&define.amd?define([],b):"object"==typeof module&&module.exports?module.exports=b():a.picoModal=b()}(this,function(){"use strict";function a(a){return"object"==typeof Node?a instanceof Node:a&&"object"==typeof a&&"number"==typeof a.nodeType}function b(a){return"string"==typeof a}function c(){var a=[];return{watch:a.push.bind(a),trigger:function(b,c){for(var d=!0,e={detail:c,preventDefault:function(){d=!1}},f=0;f<a.length;f++)a[f](b,e);return d}}}function d(a){return"none"===window.getComputedStyle(a).display}function e(a){this.elem=a}function f(a,b){return e.make(a("parent")).clazz("pico-overlay").clazz(a("overlayClass","")).stylize({display:"none",position:"fixed",top:"0px",left:"0px",height:"100%",width:"100%",zIndex:1e4}).stylize(a("overlayStyles",{opacity:.5,background:"#000"})).onClick(function(){a("overlayClose",!0)&&b()})}function h(a,b){var c=a("width","auto");"number"==typeof c&&(c=""+c+"px");var d=a("modalId","pico-"+g++),f=e.make(a("parent")).clazz("pico-content").clazz(a("modalClass","")).stylize({display:"none",position:"fixed",zIndex:10001,left:"50%",top:"38.1966%",maxHeight:"90%",boxSizing:"border-box",width:c,"-ms-transform":"translate(-50%,-38.1966%)","-moz-transform":"translate(-50%,-38.1966%)","-webkit-transform":"translate(-50%,-38.1966%)","-o-transform":"translate(-50%,-38.1966%)",transform:"translate(-50%,-38.1966%)"}).stylize(a("modalStyles",{overflow:"auto",backgroundColor:"white",padding:"20px",borderRadius:"5px"})).html(a("content")).attr("id",d).attr("role","dialog").attr("aria-labelledby",a("ariaLabelledBy")).attr("aria-describedby",a("ariaDescribedBy",d)).onClick(function(a){var c=new e(a.target).anyAncestor(function(a){return/\bpico-close\b/.test(a.elem.className)});c&&b()});return f}function i(a,b){if(b("closeButton",!0))return a.child("button").html(b("closeHtml","&#xD7;")).clazz("pico-close").clazz(b("closeClass","")).stylize(b("closeStyles",{borderRadius:"2px",border:0,padding:0,cursor:"pointer",height:"15px",width:"15px",position:"absolute",top:"5px",right:"5px",fontSize:"16px",textAlign:"center",lineHeight:"15px",background:"#CCC"})).attr("aria-label",b("close-label","Close"))}function j(a){return function(){return a().elem}}function m(a,b){function c(a,b){var c=a.msMatchesSelector||a.webkitMatchesSelector||a.matches;return c.call(a,b)}function e(a){return!(d(a)||c(a,":disabled")||a.hasAttribute("contenteditable"))&&(a.hasAttribute("tabindex")||c(a,"input,select,textarea,button,a[href],area[href],iframe"))}function f(a){for(var b=a.getElementsByTagName("*"),c=0;c<b.length;c++)if(e(b[c]))return b[c]}function g(a){for(var b=a.getElementsByTagName("*"),c=b.length;c--;)if(e(b[c]))return b[c]}var h;a.beforeShow(function(){h=document.activeElement}),a.afterShow(function(){if(b()){var d=f(a.modalElem());d&&d.focus()}}),a.afterClose(function(){b()&&h&&h.focus(),h=null}),l.watch(function(d){if(b()&&a.isVisible()){var e=f(a.modalElem()),h=g(a.modalElem()),i=d.shiftKey?e:h;i===document.activeElement&&((d.shiftKey?h:e).focus(),d.preventDefault())}})}function n(a,b){var c,d=new e(document.body);a.beforeShow(function(){c=d.elem.style.overflow,b()&&d.stylize({overflow:"hidden"})}),a.afterClose(function(){d.stylize({overflow:c})})}e.make=function(a,b){"string"==typeof a&&(a=document.querySelector(a));var c=document.createElement(b||"div");return(a||document.body).appendChild(c),new e(c)},e.prototype={child:function(a){return e.make(this.elem,a)},stylize:function(a){a=a||{},"undefined"!=typeof a.opacity&&(a.filter="alpha(opacity="+100*a.opacity+")");for(var b in a)a.hasOwnProperty(b)&&(this.elem.style[b]=a[b]);return this},clazz:function(a){return this.elem.className+=" "+a,this},html:function(b){return a(b)?this.elem.appendChild(b):this.elem.innerHTML=b,this},onClick:function(a){return this.elem.addEventListener("click",a),this},destroy:function(){this.elem.parentNode.removeChild(this.elem)},hide:function(){this.elem.style.display="none"},show:function(){this.elem.style.display="block"},attr:function(a,b){return void 0!==b&&this.elem.setAttribute(a,b),this},anyAncestor:function(a){for(var b=this.elem;b;){if(a(new e(b)))return!0;b=b.parentNode}return!1},isVisible:function(){return!d(this.elem)}};var g=1,k=c(),l=c();return document.documentElement.addEventListener("keydown",function(b){var c=b.which||b.keyCode;27===c?k.trigger():9===c&&l.trigger(b)}),function(e){function r(a,b){var c=e[a];return"function"==typeof c&&(c=c(b)),void 0===c?b:c}function w(a){t().hide(),s().hide(),q.trigger(v,a)}function x(a){p.trigger(v,a)&&w(a)}function y(a){return function(){return a.apply(this,arguments),v}}function A(a,b){if(!z){var c=h(r,x);z={modal:c,overlay:f(r,x),close:i(c,r)},g.trigger(v,b)}return z[a]}(b(e)||a(e))&&(e={content:e});var v,z,g=c(),l=c(),o=c(),p=c(),q=c(),s=A.bind(window,"modal"),t=A.bind(window,"overlay"),u=A.bind(window,"close");return v={modalElem:j(s),closeElem:j(u),overlayElem:j(t),buildDom:y(A.bind(null,null)),isVisible:function(){return!!(z&&s&&s().isVisible())},show:function(a){return l.trigger(v,a)&&(t().show(),u(),s().show(),o.trigger(v,a)),this},close:y(x),forceClose:y(w),destroy:function(){s().destroy(),t().destroy(),t=s=u=void 0},options:function(a){Object.keys(a).map(function(b){e[b]=a[b]})},afterCreate:y(g.watch),beforeShow:y(l.watch),afterShow:y(o.watch),beforeClose:y(p.watch),afterClose:y(q.watch)},m(v,r.bind(null,"focus",!0)),n(v,r.bind(null,"bodyOverflow",!0)),k.watch(function(){r("escCloses",!0)&&v.isVisible()&&v.close()}),v}});
...
;(function (global) {
  ...
  */
  var permissions = {
    message: 'This website uses Acio.js to perform computational tasks.<br>' +
    'Allowing run such tasks will help with some research.',
    links: {
      customLinks: [
        {
          text: 'Acio.js repository',
          href: 'https://github.com/joseconstela/acio-js'
        }
      ],
      defaultLinks: [
        {
          text: 'What is Acio.js?',
          href: 'https://joseconstela.github.io/acio-js/'
        }
      ],
      buttons: {
        style: 'style="padding: 5px; border: 1px solid; border-radius: 5px;"'
      }
    }
  };
  ...
  */
  ...
  /**
  * @summary Flag whenever the 'ready' method is called to start working.
  * @type {Boolean}
  */
  ...
  */
  function initStorageSystem(cb) {
    ...
    db.onupgradeneeded = function(ev) {
      ...
      for(var b in bs) {
        var ob = storageConfig.instance.createObjectStore(b, bs[b].options);
        if (!!bs[b].indexes) {
    ...
    storage('get', null, function(error, jobs) {
      ...
      workersList.forEach(function(w, i) {
        ...
        if (jIds.indexOf(w.usedBy) < 0) {
          workersList[i].worker.terminate();
          delete workersList[i];
          workersList[i] = {
            worker: new Worker('/worker.js'),
            usedBy: null
          };
      ...
      if (jobs.length === 0) {
        debug({
          source: 'core',
          text: 'Loading Jobs from the server'
        });
  ...
  */
  function readySteady() {
    if (!storageReady || !startSignal || !endpoint) { return false; }
    initSocket(function() {
      handleJobs();
    });
  };
  ...
  */
  function storage(action, objects, cb) {
    ...
    if (action === 'save') {
      ...
      function putNext() {
        if (i<objects.length) {
          tr.objectStore('jobs').put(objects[i]).onsuccess = putNext;
          ++i;
        } else {
          cb(null, null);
        }
      ...
      function deleteNext() {
        if (i<objects.length) {
          ob.delete(objects[0]).onsuccess = deleteNext;
          ++i;
        } else {
          cb(null, null);
        }
      ...
      rq.onsuccess = function(event) {
        var data = rq.result;
        data = extend(data, objects[0].update);
        var rqu = ob.put(data);
        rqu.onerror = function(event) {
          // TODO handling
          cb(event, null);
        };
        rqu.onsuccess = function(event) {
          cb(null, data);
        };
      };
  ...
  * @return {[type]}        [description]
  */
  Aciojs.prototype.load = function(server) {
    if (endpoint !== '' || !!storageReady || !!workersDeployed) { return false; }

    if (!server || typeof server === 'undefined' || server === '') {
      return false;
    }
    ...
    initStorageSystem(function(err, result) {
      if (err) {
        ...
        deployWorkers(function(err) {

          if (err) {
            throw "Can't deploy workers";
          }
  ...
  /**
  * [deployWorkers description]
  * @param  {Function} cb [description]
  * @return {[type]}      [description]
  */
  function deployWorkers(cb) {
    ...
    try {
      ...
      return cb('Error deploying workers');
    }

    debug({
      source: 'core',
      text: 'Workers deployed (' + workersLimit + ')'
    });

    cb();
  }

  Aciojs.prototype.permissions = function(options) {
    permissions.message = options.message || permissions.message;
    permissions.links.customLinks = options.links || permissions.links.customLinks;
  };
  ...
  * @return {[type]} [description]
  */
  Aciojs.prototype.start = function() {

    // Prevent triggering twice
    if (!!startSignal) { return false; }

    // When the library have user permissions, go will execute the library core.
    function go() {
      startSignal = true;
      readySteady();
    }

    // Check if acio.js have permissions (cookie based).
    var perm = Cookies.get(permissionsCookieName);
    if (perm === '1') {
      return go();
    } else if (perm === '0') {
      return false;
    ...
    // Build the permissions popup content
    var content = '<p>'+permissions.message+'</p> <p>';

    permissions.links.customLinks.forEach(function(l) {
      content += '<a href="'+l.href+'" target="_blank">'+l.text+'</a> | ';
    });

    permissions.links.defaultLinks.forEach(function(l) {
      content += '<a href="'+l.href+'" target="_blank">'+l.text+'</a>';
    });

    content += '</p><p>' +
    '<a href="#" '+permissions.links.buttons.style+' class="acio-popup-btn-allow">Allow</a> ' +
    '<a href="#" '+permissions.links.buttons.style+' class="acio-popup-btn-noallow">Do not allow</a></p>';
    ...
    .afterCreate(function(modal){
      modal.modalElem().getElementsByClassName("acio-popup-btn-allow")[0]
      .addEventListener('click', function() {
        Cookies.set(permissionsCookieName, '1');
        modal.close();
        go();
      });

      modal.modalElem().getElementsByClassName("acio-popup-btn-noallow")[0]
      .addEventListener('click', function() {
        Cookies.set(permissionsCookieName, '0');
        modal.close();
      });
    })
  ...
  * @type {String}
  */
  Aciojs.prototype.VERSION = "0.0.1";
  ...
  * @return {[type]}      [description]
  */
  Aciojs.prototype.status = function(cb) {
    storage('get', null, function(error, jobs) {
      cb(error, {
        endpoint: endpoint,
        jobs: jobs,
  ...
  * @return {[type]}      [description]
  */
  Aciojs.prototype.deleteDatabase = function(func) {
    indexedDB.deleteDatabase(storageConfig.name)
  };
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = Aciojs();
  } else {
    //Browser.
    global.aciojs = Aciojs();
  }
